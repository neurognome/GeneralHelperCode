function [new_filename] = subroutine_tifConvert_old(firstfile)
...
if ~ispc; waitfor(msgbox('Choose where you want to save the multi-tiff')); end
new_path = pwd;
new_filename = strcat(new_path,'/',new_filename);
